...
"""Description: Client 4's side: Client 4 sends her\his name and an address of the server, and the server inserts 
...
dictionary, the server sends the message client 4 sent to the other client. else: client 4 will get a message say's: 
"no such user"."""
